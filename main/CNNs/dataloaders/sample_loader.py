...
class SampleLoader(data.Dataset):
    ...
    def __init__(self, category_dict, root, loader=default_loader, transform=None, target_transform=None, sample_size=1000000):
        ...
        self.category_samples = category_dict

        category_counts = {}
        for s_idx in category_dict:
            category_counts[s_idx] = len(category_dict[s_idx])

        self.category_sample_counts = category_counts
        self.n_categories = len(category_dict)
