...
Usage:
Run this script to create a list of (image, label) pairs for Twitter_LDL dataset,
...
#dataset_dir = os.path.join('D:/Eugenia/Emotion/V2_PublicEmotion', 'Twitter_LDL')


all_data = loadmat(os.path.join(dataset_dir, 'data_twi.mat'))
img_inds = all_data['ind'][0]
all_votes = loadmat(os.path.join(dataset_dir, 'nvote_twi.mat'))
